...
supported_models = [
            ...
            'facebook/opt-125m',
            '/ssd/model/qwen15_moe_2.7b_chat',
            '/ssd/model/mixtral_8x7b_instruct_v1',
            '/ssd/model/mixtral_8x7b_instruct_v1',
            '/ssd/model/mixtral_8x7b_v1',
            '/ssd/model/qwen1.5_moe_a2.7b',
            '/ssd/model/deepseek-moe-16b-chat',
            ]
supported_datasets = ['wikitext2', 'ptb', 'c4','EBSS']
...
def parser_gen():
    ...
    parser.add_argument('--quant_test',action='store_true',default=False)
    ...
    parser.add_argument('--AGQ_GPTQ', action='store_true', default=False,help='choose gptq')
    parser.add_argument('--EBSS_calib', action='store_true', default=False,help='choose gen')
    parser.add_argument('--calib_path',type=str,default='./EBSS.json')
    ...
    parser.add_argument('--a_dynamic_method', type=str, default='pertensor')
    parser.add_argument("--human_res",type=str,default='res_moe')
    # do smooth
    parser.add_argument('--do_smooth', action='store_true', default=False,
                        help='smooth implement')
    # static option
